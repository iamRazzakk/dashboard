    ...
    return (
        <section className="md:mt-6   w-full  rounded-lg ">
            <div className="md:flex justify-between gap-4 ">
                <div className="flex px-2 py-1 shadow-lg rounded-2xl flex-1 bg-[#1e1e1e]  items-center gap-16 justify-between w-full text-white">
                    {/* First Section - Left Side */}
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h3 className="font-bold">Account Name.Bybit</h3>
                ...
                {/* Last div section */}
                <div className="shadow-lg flex-1 rounded-2xl bg-[#1e1e1e]">
